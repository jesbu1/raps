...
from rlkit.torch.torch_17_distributions.distribution import Distribution
from rlkit.torch.torch_17_distributions.transformed_distribution import (
    TransformedDistribution,
)
from rlkit.torch.torch_17_distributions.transforms import SigmoidTransform
from rlkit.torch.torch_17_distributions.utils import (
    broadcast_all,
    probs_to_logits,
    logits_to_probs,
    lazy_property,
...
class LogitRelaxedBernoulli(Distribution):
    ...
    def __init__(self, temperature, probs=None, logits=None, validate_args=None):
        ...
        super(LogitRelaxedBernoulli, self).__init__(
...
class RelaxedBernoulli(TransformedDistribution):
    ...
    def __init__(self, temperature, probs=None, logits=None, validate_args=None):
        ...
        super(RelaxedBernoulli, self).__init__(
            base_dist, SigmoidTransform(), validate_args=validate_args
        )
