...
from rlkit.torch.torch_17_distributions.dirichlet import Dirichlet
from rlkit.torch.torch_17_distributions.exp_family import ExponentialFamily
...
class Beta(ExponentialFamily):
    ...
    def __init__(self, concentration1, concentration0, validate_args=None):
        ...
        super(Beta, self).__init__(
            self._dirichlet._batch_shape, validate_args=validate_args
        )
